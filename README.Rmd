...
3. `then` is not included because the pipe `%>%` is often pronounced "then" and `find` provides the same functionality
4. `any` is not included because it collides with `base::any()` and `any_of` provides the same functionality
