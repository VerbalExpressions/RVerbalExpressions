...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/VerbalExpressions/RVerbalExpressions?branch=master&svg=true)](https://ci.appveyor.com/project/VerbalExpressions/RVerbalExpressions)
