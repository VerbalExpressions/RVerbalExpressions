...
In this example, we want to remove everything after a period. For example, NM_020506.1 should give us NM_020506:
...
2. Second, match `anything`
3. Third, use `gsub` to replace `anything` we found after the period with an empty character
